...
class TestPublish(unittest.TestCase):
   ...
   def test_single_value(self, open_mock):
      ...
      self.assertEqual( exit.called, 1 )
      self.assertEqual( exit.call_args, ((None,None,None), {}) )
      self.assertEqual( file_.write.call_args, (('a 1\n',),{})  )
   ...
   def test_string_value(self, open_mock):
      ...
      self.assertEqual( exit.called, 1 )
      self.assertEqual( exit.call_args, ((None,None,None), {}) )
      self.assertEqual( file_.write.call_args, (("a 'string arg'\n",),{})  )
   ...
   def test_list_value(self, open_mock):
      ...
      self.assertEqual( exit.called, 1 )
      self.assertEqual( exit.call_args, ((None,None,None), {}) )
      self.assertEqual( file_.write.call_args, (("a 1 2 3\n",),{})  )
   ...
   def test_double_list_value(self, open_mock):
      ...
      self.assertEqual( exit.called, 1 )
      self.assertEqual( exit.call_args, ((None,None,None), {}) )
      self.assertEqual( file_.write.call_args, (("a 'a' 'b' 'c' 2 3\n",),{})  )
